...
const seo = {
  metaTitle: "Dịch vụ Tư vấn và thực thi marketing & sales outsourcing (MSO)",
  metaDescription:
    ...
    <>
      ...
      <main className="dark overflow-hidden bg-black">
        <div className="sr-only">
          <h1>
            Mind Connector - Dịch vụ Tư vấn và Thực thi Sales & Marketing (MSO)
          </h1>
        </div>
        <section className="dark relative flex aspect-[375/461] origin-center flex-col items-center justify-end overflow-hidden bg-cover bg-center bg-no-repeat sm:aspect-[2/1] sm:justify-center lg:aspect-[3/1.2]">
          <Image
            src={`/img/bg-services-mso.png`}
            blurDataURL={`/img/bg-services-mso.png`}
            placeholder="blur"
            alt=""
            width={1400}
            height={698}
          ...
          />
          <Image
            src={`/img/bg-services-mso-mb.png`}
            blurDataURL={`/img/bg-services-mso-mb.png`}
            placeholder="blur"
            alt=""
            width={375}
            height={461}
        ...
        <section className="dark relative flex origin-center flex-col items-center justify-center py-12 text-center text-white xl:py-24">
          <Container>
            ...
            <p className="mt-8">
              Đối với các doanh nghiệp đang cần phát triển sản phẩm mới hoặc đưa
              sản phẩm ra thị trường mới, chúng tôi cung cấp dịch vụ MSO, trong
              đó vị trí chủ chốt như Sales & Marketing Director sẽ do chuyên gia
              cao cấp của chúng tôi đảm nhiệm để giúp doanh nghiệp phát triển
              đội ngũ nhân viên kinh doanh mới, tái đào tạo đội ngũ kinh doanh
              hiện tại và chuyển giao công nghệ sau khi dự án hoàn thành.
            </p>
          </Container>
        </section>
