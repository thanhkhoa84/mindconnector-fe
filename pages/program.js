  ...
  return (
    <>
      ...
      <>
        <div className="bg-[url(/img/bg-head-section.png)] bg-cover py-[3em] text-center md:py-[4em] md:pb-[0]">
          <Container>
            ...
            <div className="mt-8 flex flex-col rounded-xl text-left md:relative md:top-[35px] md:mt-0 md:h-[70px] md:flex-row md:justify-between md:bg-white md:shadow-lg">
              <div className="flex flex-col flex-nowrap items-start justify-start gap-8 rounded-2xl border-2 border-white bg-[#FFF2EB] bg-opacity-75 py-[1em] px-6 xs:flex-row sm:flex-row md:items-center md:bg-transparent">
        ...
        <Container>
          <div className="flex flex-col sm:py-8 md:py-[4em]">
            <div className="flex flex-col justify-between md:flex-row md:gap-4">
              <div className="w-full md:w-3/5 lg:w-[688px]">
                <div className="flex items-center md:h-[60px] md:rounded-md md:shadow-md">
                  <ul className="block overflow-x-auto overflow-y-hidden whitespace-nowrap ">
                    <li className="inline-block py-0 px-4 pl-0 align-middle">
                      <a className="block" href="#" className="font-bold">
                        Về chương trình
                      </a>
                    </li>
                    ...
                    <li className="inline-block py-4 px-4 pr-0 align-middle">
                      <a className="block" href="#">
                        Cách đăng ký
                      </a>
                    </li>
              ...
              <aside className="hidden w-full rounded-2xl p-4 py-8 shadow-xl md:block md:w-2/5 lg:w-[336px]">
                <SectionSubHeading>
                  Chương trình Thành công trong học tập
                </SectionSubHeading>
            ...
            <div className="mt-12 w-full md:w-3/5 lg:w-[688px]">
              <div>
                <h2 className="mb-3 text-[34px] font-black leading-[1] leading-[1.2]">
              ...
              <div>
                ...
                <div className="mt-4 overflow-hidden rounded-3xl bg-[#D34C2A] text-white">
                  ...
                  <div className="flex flex-col items-center justify-between p-6 xs:flex-row">
                    <p className="text-[14px] font-bold">
                      <span>Học phí USD$</span>{" "}
                      <span className="text-[32px]">
